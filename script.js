$(document).ready(function () {
  ...
  function createSplashIcons() {
    const iconPaths = [
      "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/main/Icons/Fire.png",
      "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/main/Icons/Ice.png",
      "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/main/Icons/Storm.png",
      "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/main/Icons/Myth.png",
      "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/main/Icons/Life.png",
      "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/main/Icons/Death.png",
      "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/main/Icons/Balance.png",
      "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/main/Icons/Shadow.png"
    ];
  ...
  const rawURLs = {
    "Amulet":  "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/refs/heads/main/DB/Amulets/Amulets_Data/Amulets_Data.json",
    "Athames": "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/refs/heads/main/DB/Athames/Athames_Data/Athames_Data.json",
    "Boots":   "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/refs/heads/main/DB/Boots/Boots_Data/Boots_Data.json",
    "Decks":   "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/refs/heads/main/DB/Decks/Decks_Data/Decks_Data.json",
    "Hats":    "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/refs/heads/main/DB/Hats/Hats_Data/Hats_Data.json",
    "Jewels":  "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/refs/heads/main/DB/Jewels/Jewels_Data/Jewels_Data.json",
    "Rings":   "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/refs/heads/main/DB/Rings/Rings_Data/Rings_Data.json",
    "Robes":   "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/refs/heads/main/DB/Robes/Robes_Data/Robes_Data.json",
    "Wands":   "https://raw.githubusercontent.com/juliandeathwizard/juliandeathwizard.github.io/refs/heads/main/DB/Wands/Wands_Data/Wands_Data.json"
  };
  ...
  // ------------------------
  // MOUNT BOOST SCHOOL DROPDOWN EXTENSION
  // ------------------------
  // Array of mount boost values that require an additional school dropdown.
  var mountBoostsThatRequireSchool = [
    "damage",
    "resistance",
    "accuracy",
    "critical rating",
  ...
  $("#mount-select").on("change", function(){
    var selectedBoost = $.trim($(this).val().toLowerCase());
    // Remove any previously added school select for this mount field.
    $(this).siblings(".mount-school-select-wrapper").remove();
    
    if (mountBoostsThatRequireSchool.indexOf(selectedBoost) !== -1) {
       var schoolSelect = $(`
         <select class="mount-school-select">
           <option value="" disabled selected>Choose School</option>
           <option value="fire">Fire</option>
           <option value="ice">Ice</option>
           <option value="storm">Storm</option>
       ...
       `);
       var wrapper = $('<div class="mount-school-select-wrapper"></div>');
       wrapper.append(schoolSelect);
       // Append the school dropdown under the mount select's parent.
       $(this).parent().append(wrapper);
       // Initialize the new select2 dropdown.
  ...
  // ------------------------------------
  // CALCULATE FINAL STATS FUNCTION (Extended to include Jewels, Pet Talents, and Mount Boost)
  // ------------------------------------
  function calculateFinalStats() {
    ...
    // --- Process Mount Boost ---
    let mountBoostType = $("#mount-select").val();
    let mountBoostValue = parseFloat($("#mount-stat").val());
    if (mountBoostType && !isNaN(mountBoostValue)) {
      mountBoostType = mountBoostType.toLowerCase().trim();
      // Look for an appended mount school dropdown.
      let mountSchoolSelect = $("#mount-select").siblings(".mount-school-select-wrapper").find(".mount-school-select");
      let mountSchool = mountSchoolSelect.length ? mountSchoolSelect.val() : null;

      // Helper: add mount boost value to a school-based aggregated object.
      function addMountBoost(aggregatedObj) {
        if (mountSchool && mountSchool !== "" && mountSchool !== "global") {
          aggregatedObj[mountSchool] += mountBoostValue;
        } else {
          for (let key in aggregatedObj) {
            aggregatedObj[key] += mountBoostValue;
          }
        }
      }

      switch (mountBoostType) {
        case "damage":
          addMountBoost(aggregatedDamage);
          break;
        case "resistance":
          addMountBoost(aggregatedResistance);
          break;
        case "accuracy":
          addMountBoost(aggregatedAccuracy);
          break;
        case "critical rating":
          addMountBoost(aggregatedCritical);
          break;
        case "critical block rating":
          addMountBoost(aggregatedCriticalBlock);
          break;
        case "armor piercing":
          addMountBoost(aggregatedArmorPiercing);
          break;
        case "pip conversion":
          addMountBoost(aggregatedPipConversion);
          break;
        default:
          console.warn("Unrecognized mount boost type:", mountBoostType);
      }
    }
